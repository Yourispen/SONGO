...
public class Couleur_Change_Online : Script_Couleur_Change
{
    [Header("scripts")]
    public Couleur_Change_Online couleur_change;
    public Controller_Match_Online controlleur;
    ...
    public void initialise_couleur()
    {
        ...
        couleur_change.GetComponent<Couleur_Change_Online>().enabled = false;
    }
