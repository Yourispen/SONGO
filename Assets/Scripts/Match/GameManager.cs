...
public class GameManager : MonoBehaviourPunCallbacks
{
    ...
    //le nombre de fois que le joueur s'est reconnect�
    ...
    public void quitter_le_match()
    {
        ...
        {
            Debug.Log("je suis connect�, donc je me d�connecte avant de quitter la sc�ne.");
            PhotonNetwork.Disconnect();
        }
        else
        {
            Debug.Log("je ne suis pas connect�, donc je quitte la sc�ne.");
    ...
    void match_debute()
    {
        Debug.Log(PhotonNetwork.PlayerListOthers[0].ToString() + " a " + PhotonNetwork.PlayerListOthers[0].ToString().Length + " caract�res");
    ...
    void adversaire_quitte_le_match()
    {
        ...
        Debug.Log(nom_joueur + " a quitt� le match.");
    ...
    {
        Debug.Log("Connexion � internet...");
    }
    public override void OnConnectedToMaster()
    {
        PhotonNetwork.MaxResendsBeforeDisconnect = 1;
        Debug.Log(PhotonNetwork.LocalPlayer.NickName + " est connect�(e) � photon...");
    ...
    public override void OnJoinedRoom()
    {
        if (debut_du_match && !controller_match.match_fini)
        {
            ...
            PhotonNetwork.MaxResendsBeforeDisconnect = 1;
            Debug.Log(PhotonNetwork.LocalPlayer.NickName + " s'est reconnect� au Match " + PhotonNetwork.CurrentRoom.Name);
            initialise_GameCenter();
            controller_scene.afficher_message("", false);
        }
    }
