...
public class Script_Controller_Match : MonoBehaviour
{
    ...
    [Header("temps de d�pot des pions et transition des couleurs")]
    //temps mis apr�s le d�pot d'un pion
    ...
    //g�n�rer les pions pour le match
