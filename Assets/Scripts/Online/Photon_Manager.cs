...
public class Photon_Manager : MonoBehaviourPunCallbacks
{
    ...
    public void bouton_match()
    {
        StartCoroutine(checkInternetConnection((est_connecte) =>
        {
            if (est_connecte)
            {
                //si le joueur est connect� � internet
    ...
    public void lister_les_matchs()
    {
        ...
        Debug.Log("V�rifie s'il y a des matchs disponibles");
    ...
    public override void OnCreateRoomFailed(short returnCode, string message)
    {
        ...
        Debug.Log("vous n'avez pas pu cr�er le match");
    ...
    public override void OnCreatedRoom()
    {
        //base.OnCreatedRoom();
        numero_joueur = 1;
        Debug.Log("Match : "+PhotonNetwork.CurrentRoom.Name+" est cr�e");
    }
