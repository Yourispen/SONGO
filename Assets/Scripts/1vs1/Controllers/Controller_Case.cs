...
public class Controller_Case : Script_Controller_Case
{
    #region Variables
    ...
    //case suivante
    public Controller_Case case_suivante;
    //case précédante
    public Controller_Case case_precedante;
    //case de début de l'adversaire
    public Controller_Case case_debut_adversaire;
    //grande case du joueur 2
    public Controller_Case grande_case_adversaire;
    //grande case du joueur 2
    public Controller_Case grande_case_joueur;
    ...
    private void jouer()
    {
        ...
        if (numero_case == 7 && (controlleur_match.nombre_de_pions_null(numero_joueur, 6) && numero_joueur == 1 || controlleur_match.nombre_de_pions_null(numero_joueur, 13) && numero_joueur == 2))
        {
            if (pions_case.Count == 1)
            {
                ...
                couleur_change.GetComponent<Couleur_Change>().enabled = true;
                //faire une copie
    ...
    public IEnumerator case_suivante_avec_une_pause(Controller_Case _case_suivante, List<GameObject> _pions, int compteur_pion, bool case_debut)
    {
